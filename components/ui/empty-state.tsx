...
export function EmptyState({ title, description, icon, action, className, type = "empty" }: EmptyStateProps) {
  ...
  return (
    <Card className={cn("border-dashed", className)}>
      <CardContent className={cn("flex flex-col items-center justify-center text-center p-6", getBackgroundColor())}>
